...
sudo keytool -importcert -file epa-as-1-ref.epa4all.de.pem -alias epa-as-1-ref.epa4all.de -cacerts
sudo keytool -importcert -file epa-as-2-ref.epa4all.de.pem -alias epa-as-2-ref.epa4all.de -cacerts
