...
public class JEventJournalResource extends AbstractResource {
    ...
    private static final Logger log = LoggerFactory.getLogger(org.apache.jackrabbit.webdav.jcr.EventJournalResourceImpl.class);

    private final HttpServletRequest request;
    private final EventJournal journal;
    private final DavResourceLocator locator;

    public JEventJournalResource(
        ...
        try {
            ...
            if (outputContext.hasStream()) {
                ...
                while (!events.isEmpty()) {
                    ...
                    String author = firstEvent.getUserID() == null || firstEvent.getUserID().isEmpty() ? null
                    ...
                    for (Event e : bundle) {
                        ...
                        // user data
                        if (e.getUserData() != null && !e.getUserData().isEmpty()) {
