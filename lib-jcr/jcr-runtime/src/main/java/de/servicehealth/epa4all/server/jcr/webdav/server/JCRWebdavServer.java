...
public class JCRWebdavServer implements JDavSessionProvider {
    ...
    /** the default logger */
    private static final Logger log = LoggerFactory.getLogger(org.apache.jackrabbit.server.jcr.JCRWebdavServer.class);
     ...
     */
    public boolean attachSession(JWebdavRequest request)
        throws DavException {
    ...
    private class SessionCache {
        ...
        private final ConcurrentMap<DavSession, Set<Object>> sessionMap;
        private final ConcurrentMap<Object, DavSession> referenceToSessionMap;
         ...
         * @throws DavException
         */
        private DavSession get(JWebdavRequest request)
            throws DavException {
         ...
         */
        private Session getRepositorySession(JWebdavRequest request) throws DavException {
            try {
