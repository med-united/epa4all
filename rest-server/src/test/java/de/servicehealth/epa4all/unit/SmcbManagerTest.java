...
class SmcbManagerTest {
    ...
    void testExtractTelematikIdFromCertificate() {
        try {
            ...
            String autRsaCertPath = "/certs/SMC-B/Bad_ApothekeTESTONLY-80276883110000116352-aut-rsa.cer";
            InputStream inputStream = getClass().getResourceAsStream(autRsaCertPath);
