 ...
 */
public class JEventJournalResourceImpl extends AbstractResource {
    ...
    private static Logger log = LoggerFactory.getLogger(org.apache.jackrabbit.webdav.jcr.EventJournalResourceImpl.class);

    private final HttpServletRequest request;
    private final EventJournal journal;
    private final DavResourceLocator locator;

    public JEventJournalResourceImpl(
