...
public class KBVFHIRUtil {
    ...
    public static Patient UCPersoenlicheVersichertendatenXML2Patient(UCPersoenlicheVersichertendatenXML schaumberg) {
        ...
        if (strassenAdresse.getAnschriftenzusatz() != null) {
            patient.getAddress().getFirst().addLine(strassenAdresse.getAnschriftenzusatz());
            StringType line = patient.getAddress().getFirst().getLine().get(1);
        ...
        StringType line = patient.getAddress().getFirst().getLine().get(0);
    ...
    public static Bundle assembleBundle(
    ...
    public static Composition createComposition(
        ...
        // todo add 04 Entlassmanagement, 07 TSS Kennzeichen, 10 nur Ersatzverordnungskennzeichen, 11 ASV+Ersatzverordnung, 14 Entlass+Ersatz, 17 TSS+Ersatz
