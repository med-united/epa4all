...
import org.apache.jackrabbit.webdav.jcr.JEventJournalResourceImpl;
import org.apache.jackrabbit.webdav.jcr.JRootCollection;
import org.apache.jackrabbit.webdav.jcr.JWorkspaceResourceImpl;
...
public class JDavResourceFactoryImpl implements DavResourceFactory {

    private static final Logger log = LoggerFactory.getLogger(JDavResourceFactoryImpl.class);
     ...
     * @param subsMgr
     */
    public JDavResourceFactoryImpl(TxLockManagerImpl txMgr, SubscriptionManager subsMgr) {
        this.txMgr = txMgr;
    ...
    public DavResource createResource(
        ...
        JDavServletRequest request,
        JDavServletResponse response
    ) throws DavException {
        ...
        if (locator.isRootLocation()) {
            ...
            try {
                ...
                resource = new JEventJournalResourceImpl(ej, locator, session, request, this);
            ...
            // workspace resource
            resource = new JWorkspaceResourceImpl(locator, session, this);
        } else {
    ...
    public DavResource createResource(DavResourceLocator locator, DavSession session) throws DavException {
        ...
        if (locator.isRootLocation()) {
            ...
            resource = new JWorkspaceResourceImpl(locator, sessionImpl, null);
        } else {
            try {
