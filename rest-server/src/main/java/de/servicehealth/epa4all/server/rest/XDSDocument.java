...
public class XDSDocument extends AbstractResource {
    ...
    private ProvideAndRegisterDocumentSetRequestType prepareDocumentSetRequest0(
        byte[] documentBytes,
        String kvnr,
        String contentType,
        String languageCode,
    ...
    private ProvideAndRegisterDocumentSetRequestType prepareDocumentSetRequest(byte[] documentBytes, String kvnr) {
        Document document = new Document();
        document.setValue(documentBytes);
        String documentId = "DocumentEntry-0";
        document.setId(documentId);
