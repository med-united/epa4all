...
public class IdpUtils {
    ...
    public static String getSignedJwt(
        ...
        final JsonWebSignature jsonWebSignature = getJsonWebSignature(certificateInfo.getCertificate(), nonce, payload);
        ...
        byte[] signatureBytes = hashAndSignBytesWithExternalAuthenticateWithSMCB(challengeBytes, certificateInfo.getSignatureType(), smcbHandle, idpFunc);
    ...
    public static JsonWebSignature getJsonWebSignature(X509Certificate certificate, boolean nonce, String payload) {
        ...
        jsonWebSignature.setHeader(TYPE.getJoseName(), "JWT");
        ...
        if (nonce) {
            ...
            jsonWebSignature.setHeader(CONTENT_TYPE.getJoseName(), "NJWT");
    ...
    public static byte[] hashAndSignBytesWithExternalAuthenticateWithSMCB(
        ...
        // todo verifyPin on CetpException
