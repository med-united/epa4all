 ...
 */
public final class JDavMethods {
     ...
     */
    private static final int[] labelMethods;

    /**
     * An array of method codes defined by RFC 3253 (deltaV)
     */
    private static final int[] deltaVMethods;
     ...
     */
    public static boolean isCreateRequest(JDavServletRequest request) {
     ...
     */
    public static boolean isCreateCollectionRequest(JDavServletRequest request) {
        int methodCode = getMethodCode(request.getMethod());
     ...
     */
    public static boolean isMethodAffectedByLabel(JDavServletRequest request) {
     ...
     */
    public static boolean isDeltaVMethod(JDavServletRequest request) {
        int code = getMethodCode(request.getMethod());
    ...
    public static List<Locale> parseAcceptLanguageHeader(String header) {
        ...
        for (String part : parts) {
            ...
            String localeStr = subParts[0].trim();
            String language = localeStr;
            String country = "";

            int dashIndex = localeStr.indexOf('-');
            if (dashIndex > 0) {
                language = localeStr.substring(0, dashIndex);
                country = localeStr.substring(dashIndex + 1);
            }
            result.add(Locale.of(language, country));
        }
        return result;
    }
}
